...
<html>
 ...
 <body>
    ...
    <div id="contents">
     ...
     <div id = "main_man"><br/>
	 <a href= "ShowAdmin.php"><center> <button id="ser_btn" type="button" class="btn btn-danger">Candidates</button></center></a>
        
         
         <a href= "Result.php"><center><button  id="insr_btn" type="button" class="btn btn-danger">Result </button></center></a><br>
	<a href="control.php"><center><button id="insr_btn" type="button" class="btn-danger">control</button></center></a><br>
       	 <a href='models/logout.php'><center><button  id="insr_btn" type="button" class="btn btn-danger">logout</button></center></a><br><br>

...
<html>
 ...
 <body>
    ...
    <div id="contents">
     ...
     <div id = "main_man"><br/><br>
	 <a href= "AdminShow.php"><center> <button id="ser_btn" type="button" class="btn btn-danger">Show candidates</button></center></a>
        
         <a href= "Insertcandidates.php"><center><button  id="insr_btn" type="button" class="btn btn-danger">Register </button></center></a><br><br><br>
       
         <a href= "Deletecandidates.php"><center><button id="del_btn" type="button" class="btn btn-danger">Delete</button></center>
         </a><br><br>
        <a href= "Search.php"><center> <button id="ser_btn" type="button" class="btn btn-danger">Search</button></center></a>

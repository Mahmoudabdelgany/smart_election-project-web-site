...
<br>
<br>
<center><h3>choose your pic of SSN to check your National card</h3></center>
<br>
<br>
<script>
function saveAndSubmit()
{
  ...
  if (document.formName.content.value == '')
  {
   ...
   return false;
    ...
    var queryString = "models/checkssn.php?Approve=Yes";
...
<form   method='POST' name="formName"  onSubmit="return Validate()">
<input type="file" id="file" name="file">
<p >Qr Content:<br> <textarea  id="content" name="q" readonly></textarea></p>

<!--To Read QR Code-->
<script type="text/javascript" src="js/qrReader.js"></script>
<input  type="submit" name="submit"   onClick="javascript:saveAndSubmit()" value="   Next   ">

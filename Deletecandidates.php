 ...
 <body>
    ...
    <div id="header">
       ...
       <div id="contents">
            ...
            <h1 id="del_h1">Delete Candidates</h1><br>
            <form action="models/Delete_candidates.php" method="GET" >
               
        <div id="man_del"> 
            <div id="input_man"><p>Candidates Nat_ID </p> <br><br> <br><br>
                <input type="Text" placeholder="Enter Your Nat_ID here" name="Nat_ID" ></div> <br><br>
           
            <button id="" type="submit" value="Delete" name="DeleteT" onclick="models/Delete_candidates.php">Delete</button>

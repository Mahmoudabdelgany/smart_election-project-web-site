...
if (!isset($_SESSION['Nat_ID'])) {
  header('location:loginvoters.php');
exit;
...
<?php
    ...
    ?>
    <div id="contents">
        <h1 id="ser_h1"> Choose Candidates</h1>
					...
					echo '<td><center><img src="'.$row['image'].'"  width="140" height="100" /></center></td>';
...
echo "<td><p data-placement='top' data-toggle='tooltip' title='votes'><center><a href='models/U_count.php?id=$row[id]' class='btn btn-primary btn-xs' data-title='Edit' data-toggle='modal' data-target='#edit'  >vote <span class='glyphicon glyphicon-pencil'></span></a></center></p></td>";

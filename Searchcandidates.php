...
<html>
 ...
 <body>
    ...
    <div id="contents">
        <h1 id="ser_h1">Search Candidates</h1>
        <form id="ser_frm" method="GET" action="Show_Candidates.php">
                <div > 
               
                    <p>Candidates ID </p> <br><br>
                    <input type="Text" placeholder="Enter Your Nat_ID here" name="Nat_ID" > <br><br>

...
<html>
 ...
 <body>
    ...
    <div id="contents">
       <center> <h1  >controlling </h1></center>
    	 
             
             
                    <form action="models/control.php"  method="POST">
                       
                        <label for="Election">Choose Your need:</label>
<br><br>


  <select name="Election" id="Election">
<option value="-1">choose</option>
  <option value="0">Start Election</option>
  <option value="1">End Election</option>
  
</select>
<br><br>
	
<label for="Results">Choose Your need:</label>
<br><br>


  <select name="Results" id="Results">
<option value="-1">choose</option>
  <option value="1">show Results</option>
  <option value="0">Hide Results</option>
  
</select>
<br><br>
		<input id="lg_btn" class="btn-primary btn-lg" type="submit" name="submit" value="update">

...
<html>
    ...
    <div id="contents">
       <center> <h1  id="log_h1">Login  </h1></center>
              ...
              <div class="login">
                    ...
                    <form action="models/LoginAdmin.php"  method="POST">
                       <p> UserName </p> <input required="required" name="username" class="input-lg" type="text" placeholder="please enter a username"><br>
                        <br> <p> Password</p> <input required="required" id="myInput" name="Nat_ID" onkeypress="return onlyNumberKey(event)" maxlength='14' minlength='10' class="input-lg" type="password" placeholder="please enter a password">  <br>
                         <br>
 ...
 <br>  
			...
			<input id="lg_btn" class="btn-primary btn-lg" type="submit" name="submit" value="Login">
